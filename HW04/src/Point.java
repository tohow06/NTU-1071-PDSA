...
public class Point implements Comparable<Point> {
    ...
    public double slopeTo(Point that) {
        ...
        return (that.y - this.y) / (that.x - (double) (this.x));
    }
    ...
    private static class slopeComparator implements Comparator<Point> {
        ...
        public int compare(Point v, Point m) {
            if (og.slopeTo(v) > og.slopeTo(m)) return  1;
            if (og.slopeTo(v) < og.slopeTo(m)) return  -1;
            return 0;
        }
    }
    ...
    public static void main(String[] args) {
        ...
        Point tt = new Point(1, 4);

        System.out.println(a.slopeOrder().compare(a, a));
